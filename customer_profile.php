...
<h2 class="text-center">Create Account:</h2>
  <form action="customer_register.php" method="post" autocomplete="off">
  ...
  <div class="form-group">
	...
	<input type="password" name="password"  class="form-control" value="<?=$password;?>" autocomplete="off">
	</div>

	<div class="form-group">
	<button type="submit" style="width:100%" value="Register Apexcure Account" class="btn btn-primary"id="text"></button
	</div>
...
<b>	<P2 class="text-left">Already have an account?<a href="customer_login.php" > Login</a></P2><b>
  </div>
